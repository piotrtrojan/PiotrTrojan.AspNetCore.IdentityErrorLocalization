...
namespace PiotrTrojan.AspNetCore.IdentityErrorLocalization.pt_br_PT_BR
{
    public class PortugueseBrIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName) => new() { Code = nameof(DuplicateUserName), Description = $"O usuário '{userName}' já está sendo utilizado." };
        ...
        public override IdentityError InvalidUserName(string userName) => new() { Code = nameof(InvalidUserName), Description = $"O usuário '{userName}' é inválido. Deve conter apenas letras ou dígitos." };
        ...
        public override IdentityError UserLockoutNotEnabled() => new() { Code = nameof(UserLockoutNotEnabled), Description = "Lockout não está disponível para este usuário." };
        public override IdentityError UserNotInRole(string role) => new() { Code = nameof(UserNotInRole), Description = $"O usuário não tem a permissão '{role}'." };
    }
}
